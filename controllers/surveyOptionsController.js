...
const table = "survey_options"; //! Tablo Adı
...
exports.DataAddToken = async(req,res) => {
    ...
    try {
        ...
        const created_byId = decoded?.id; //! Kullanıcı Id

        delete postAll?.created_byToken; //! Sil
        postAll["created_byId"] = created_byId; //! Ekleme
        const result = await dbModel.createDB(table,postAll); //! Model
